...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Use — Airavoto Gaming POS" },
      { name: "description", content: "Terms of use for Airavoto Gaming POS." },
    ],
  }),
  component: TermsPage,
});
      ...
      <Section>
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-12 flex flex-wrap gap-4 border-t border-border/60 pt-8 text-sm">
            ...
            <Link to="/faq" className="text-foreground/80 hover:text-foreground">
              FAQ →
            </Link>
          </div>
        </div>
