...
function RoadmapPage() {
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden pb-16 pt-36 sm:pt-44">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-5 text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
            A transparent look at the features we're building, planning and considering. All
            updates ship free.
          </p>
        </div>
      </section>
      ...
      <Section>
        <SectionHeading
          eyebrow="Already shipped"
          title="What's in the current release"
          subtitle="Every feature below is available in the free download today."
        />
            ...
            <div key={q.label} className="panel overflow-hidden">
              ...
              <div className="flex items-center justify-between border-b border-border/60 px-6 py-4">
                ...
                <span
                  ...
                  style={{ background: `${q.statusColor}22`, color: q.statusColor }}
                >
                  {q.status}
                </span>
              </div>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-surface px-6 py-16 text-center">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-4 max-w-md text-sm text-muted-foreground">
              Every feature on this roadmap will ship as a free update. Download now and get it
              all as it arrives.
            </p>
